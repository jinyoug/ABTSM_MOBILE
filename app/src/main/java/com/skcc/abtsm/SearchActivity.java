...
public class SearchActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    public void onMapReady(GoogleMap map) {
        ...
        /*?òÏ§ë?? ?¥Î¶¥Î∂ÄÎ∂? new BTS?êÎäî JsonArrayÎ°? Î∂Ä?? Î∞õÏ? Í∞?
        for(int i=0; i<count;i++){
            BTS_temp = new BTS("AB3234D", 37.366386, 127.106660 , 0,
                    "Î∂ÑÎãπÍµ? Ï≤´Î≤àÏß?", "306??", "2017-08-18", "2018-01-01")
        ...
        BTSList.add(new BTS("AB3234D", 37.365002, 127.112362 , 0,
                "Î∂ÑÎãπÍµ? ?êÎ≤àÏß?", "306??", "2017-08-18", "2018-01-01"));
        BTSList.add(new BTS("AB3234D", 37.374918, 127.116285 , 0,
                "Î∂ÑÎãπÍµ? ?∏Î≤àÏß?", "306??", "2017-08-18", "2018-01-01"));
